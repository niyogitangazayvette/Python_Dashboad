...
data = (
    pd.read_csv(r"C:\Users\user\Downloads\Dashboad\assets\avocado.csv")
...
def update_charts(region, avocado_type, start_date, end_date):
    ...
    price_chart_figure = {
        ...
        "layout": {
            "title": {"text": "Average Price of Avocados", "x": 0.05, "xanchor": "left"},
...
#  Run the app using updated syntax
